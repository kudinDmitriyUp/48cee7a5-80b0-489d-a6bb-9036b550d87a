...
export const metadata: Metadata = {
  title: "Sushi Artisan - Premium Handcrafted Sushi Dining",
  description: "Experience authentic Japanese sushi crafted with fresh ingredients and traditional techniques. Reserve your table for an unforgettable dining experience.",
  keywords: ["sushi restaurant", "authentic Japanese cuisine", "fresh sushi", "handcrafted rolls", "nigiri", "sashimi", "fine dining"],
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Sushi Artisan - Premium Handcrafted Sushi Dining",
    description: "Experience authentic Japanese sushi crafted with fresh ingredients and traditional techniques.",
    type: "website",
    siteName: "Sushi Artisan",
    url: "https://sushiartisan.com"
  },
  twitter: {
